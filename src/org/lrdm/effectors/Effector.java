...
public class Effector {
    ...
    private final Map<Integer,Integer> setTargetAL;
    ...
    public Action setSetMirrorChanges(int t, MirrorChange a) {
        setMirrorChanges.put(t, a);
        return a;
    }
    ...
    public Action setSetTargetLinksPerMirror(int t, TargetLinkChange tlc) {
        setTargetedLinkChanges.put(t, tlc);
        return tlc;
    }

    //TODO: implement usage later
    public Integer setTargetAL(int timestamp, int value) {
        setTargetAL.put(timestamp, value);
        return value;
    }

    public Map<Integer, Integer> getSetTargetAL() {
        return setTargetAL;
    }
    ...
    public Map<Integer, MirrorChange> getSetMirrorChanges() {
        return setMirrorChanges;
    }
}
